...
class PurchaseOrder(models.Model):
    ...
    _sql_constraints = [
        ('general_discount_limit', 'CHECK (general_discount <= 100.0)',
    ...
    def onchange_general_discount(self):
        ...
        self.mapped('order_line').update({
            discount_field: self.general_discount,
        })
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False,
        ...
        """The purpose of this is to write a context on "order_line" field
         ...
         There is a PR (https://github.com/flectra/flectra/pull/26607) to flectra for
