...
flectra.define('web_widget_x2many_2d_matrix.X2Many2dMatrixRenderer', function (require) {
    "use strict";

    // Heavily inspired by Flectra's `ListRenderer`
    ...
    var X2Many2dMatrixRenderer = BasicRenderer.extend({
        ...
        * @override
        * @private
        * @param {FlectraEvent} event "navigation_move" event
        */
